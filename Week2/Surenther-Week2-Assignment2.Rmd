...
weekdays2_mean
```
### Week1, Week2 Mean Comparision
```{r}
# Determine if the total sleep in week 1 is less than week 2 by using the < operator
weekdays1_mean > weekdays2_mean
```

### No of days greater than 8 hrs
```{r}
...
### Matrix Change row and col names
```{r}
